...
inline void SM_Event::set_event_time(const char* value, size_t size) {
  set_has_event_time();
...
inline ::std::string* SM_Event::release_event_time() {
  ...
  clear_has_event_time();
  return event_time_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
